...
def get_model(args):
    ...
    if args.backbone_name == "resnet18_cub":
    ...
    elif args.backbone_name == "resnet50_cifar":
        from pytorchcv.model_provider import get_model as ptcv_get_model
        model = ptcv_get_model("resnet50", pretrained=True, root=args.out_dir)
    ...
    [
        ...
        model, backbone, model_top = get_derma_model(args, args.backbone_name.lower())
        preprocess = transforms.Compose([
        ...
        raise ValueError(args.backbone_name)
